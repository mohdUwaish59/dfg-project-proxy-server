...
export default function FemaleRedirectPage() {
  ...
  const fetchRedirectUrl = async () => {
    try {
      ...
      if (response.ok && data.femaleRedirectUrl) {
        setRedirectUrl(data.femaleRedirectUrl);
      } else {
        setError('Female redirect URL not configured. Please contact the administrator.');
      }
    } catch (error) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-background to-rose-50 flex items-center justify-center">
        <motion.div
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-background to-rose-50 flex items-center justify-center p-4">
      <motion.div
      ...
      >
        <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm">
          <CardHeader className="text-center space-y-4">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-pink-100 to-rose-200">
          ...
          <CardContent className="space-y-6">
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-pink-600 to-rose-700 hover:from-pink-700 hover:to-rose-800" 
              size="lg"
            >
